...
> Internal development reference. Adapted from superpowers writing-skills (MIT license, Copyright Jesse Vincent 2025). Not a user-facing skill.
...
You: Searching...
[Dispatch subagent, then synthesis]
```
...
- Good: `**REQUIRED SUB-SKILL:** Use skill-name`
- Good: `**REQUIRED BACKGROUND:** You MUST understand skill-name`
