...
# Priority:
#   1. .lorekeeper/config.json:knowledgeBasePath in CWD
#   2. $KNOWLEDGE_BASE_PATH env var
#   3. ./docs/shared-knowledge or ./shared-knowledge or ./knowledge sibling fallback
KNOWLEDGE_MSG=""
RESOLVED_PATH=""
